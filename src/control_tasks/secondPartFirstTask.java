...
public class secondPartFirstTask {
    public static void main(String[] args) {
        ...
        int countHuman = lastPrint;
        printHash(lastPrint);
        lastPrint = random.nextInt(12)+1;
        lastPrint = askPrint(scanner,print,lastPrint,  sumCoins);
        printHash(lastPrint);
        int countComputer = lastPrint;
        int differenceCount = countMore(countComputer, countHuman);
        System.out.println("Congratulations!!!");
    }
    private static int countMore(int countComputer, int countHuman){
